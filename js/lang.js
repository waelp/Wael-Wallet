const Lang = {
    ...
    dictionary: {
        ar: {
            ...
            quarterly_report: 'التقرير الربع سنوي',
            expected_expenses: 'المصاريف المتوقعة (أقساط)',
            financial_health: 'الملخص المالي',
            categories: {
                personal: 'شخصية',
        ...
        en: {
            ...
            expected_expenses: 'Expected Expenses (Installments)',
            financial_health: 'Financial Summary',
            categories: {
                personal: 'Personal',
                groceries: 'Groceries',
                schools: 'Schools',
