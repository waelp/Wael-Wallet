const app = {
    ...
    init() {
        try {
            ...
            const savedBg = localStorage.getItem('bg_class');
            if (savedBg) {
    ...
    setBackground(className) {
        ...
        document.body.classList.remove('bg-default', 'bg-blue', 'bg-green', 'bg-rose', 'bg-slate', 'bg-dark');

        // Add new class
        if (className !== 'bg-default') {
            document.body.classList.add(className);
        }

        localStorage.setItem('bg_class', className);
    },
    ...
    navigate(tab) {
        ...
        document.getElementById('footer-signature').style.display = 'block';
    ...
    render() {
        ...
        switch (this.currentTab) {
            ...
            case 'settings':
                ...
                break;
            case 'reports':
                main.innerHTML = UI.renderReports();
                break;
        }
